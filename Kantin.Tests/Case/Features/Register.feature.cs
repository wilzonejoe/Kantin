...
namespace Kantin.Tests.Case.Features
{
    ...
    [NUnit.Framework.TestFixtureAttribute(TestName="Register")]
...
#line hidden
#line 6
 testRunner.Then("LoginResult should be successful", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 7
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("myphunguyen", "jimmy", "-Test123", "plexure", null, TestName="As a user, i should not be able to register if username has taken(myphunguyen,jim" +
            "my,-Test123,plexure)")]
        public virtual void AsAUserIShouldNotBeAbleToRegisterIfUsernameHasTaken(string fullname, string username, string password, string organisationName, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "exceptionflow"};
            if ((exampleTags != null))
...
#line hidden
#line 18
 testRunner.Then("LoginResult should be conflicted", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
